...
(function() {
  var DateRound, UnitError, method, name, singularize, timeMethod,
  ...
  UnitError = (function(superClass) {
    extend(UnitError, superClass);

    function UnitError(unit) {
      this.name = "DateRound.UnitError";
  ...
  DateRound.add = function(date, value, unit) {
    date = new Date(date);
  ...
  DateRound.subtract = function(date, value, unit) {
    return DateRound.add(date, value * -1, unit);
  };

  DateRound.floor = function(date, unit) {
    var dow, snit;
    date = new Date(date);
  ...
  DateRound.ceiling = function(date, unit) {
    ...
    if (date.getTime() === floor.getTime()) {
      ...
      return DateRound.add(floor, 1, unit);
    }
  };
  ...
  for (name in DateRound) {
    method = DateRound[name];
